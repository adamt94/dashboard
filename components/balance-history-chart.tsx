    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Track your total balance over time</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-[300px] flex items-center justify-center text-muted-foreground">
            No trade history available yet. Add your initial balance and close some trades to see your balance history.
          </div>
        </CardContent>
      </Card>
    )
        ...
        <div className="flex items-center justify-between">
          ...
          <Tabs value={period} onValueChange={(v) => handlePeriodChange(v as typeof period)}>
            <TabsList>
              ...
              <TabsTrigger value="monthly" disabled={isPending}>
                Monthly
              </TabsTrigger>
              <TabsTrigger value="yearly" disabled={isPending}>
                Yearly
              </TabsTrigger>
            </TabsList>
          </Tabs>
